...
class BreakDown {
    ...
    private NotknownRange get_garbage_indices_and_update_current_index() {
        ...
        // @Important. The character sequences that produce errors must come first.
        ...
        if(index_of_func != -1) {
            ...
            nr.end_index = index_of_func;
            nr.is_active = true;

            current_index = index_of_func - 1; // -1 because the for loop is going to increment the current_index
            last_sequence_index = index_of_func - 1;

            return nr;
        }

        // Checking for while
        int index_of_while = str.indexOf("while", current_index);
        if(index_of_while != -1) {
            nr.start_index = current_index;
            nr.end_index = index_of_while;
            nr.is_active = true;

            current_index = index_of_while - 1; // -1 because the for loop is going to increment the current_index
            last_sequence_index = index_of_while - 1;

            return nr;
        }

        // Checking for if
        int index_of_if = str.indexOf("if", current_index);
        if(index_of_if != -1) {
            nr.start_index = current_index;
            nr.end_index = index_of_if;
            nr.is_active = true;

            current_index = index_of_if - 1; // -1 because the for loop is going to increment the current_index
            last_sequence_index = index_of_if - 1;
        ...
        if(index_of_else != -1) {
            nr.start_index = current_index;
            nr.end_index = index_of_else;
            nr.is_active = true;

            current_index = index_of_else - 1; // -1 because the for loop is going to increment the current_index
            last_sequence_index = index_of_else - 1;
        ...
        if(index_of_else_if != -1) {
            ...
            current_index = index_of_else_if - 1; // -1 because the for loop is going to increment the current_index
            last_sequence_index = index_of_else_if - 1;
        ...
        if(index_of_use != -1) {
            nr.start_index = current_index;
            nr.end_index = index_of_use;
            nr.is_active = true;

            current_index = index_of_use - 1; // -1 because the for loop is going to increment the current_index
            last_sequence_index = index_of_use - 1;
    ...
    private String var_assign_value() {
        ...
        if(c == '=') {
            ...
            value = "<var_assign>";
            value += "<" + str.substring(current_index + 1, current_index) + ">";
    ...
    StringBuffer get_broken_string() {
        StringBuffer broken_string = new StringBuffer();
        ...
        for(current_index = 0; current_index < str.length(); current_index++) {
            ...
            if(!enum_value.equals(""))
                broken_string.append(enum_value);
            else if(!use_value.equals(""))
                broken_string.append(use_value);
            else if(!else_if_value.equals(""))
                broken_string.append(else_if_value);
            else if(!else_value.equals(""))
                broken_string.append(else_value);
            else if(!if_value.equals(""))
                broken_string.append(if_value);
            else if(!while_value.equals(""))
                broken_string.append(while_value);
            else if(!var_assign_value.equals(""))
                broken_string.append(var_assign_value);
            else if(!var_declare_2_value.equals(""))
                broken_string.append(var_declare_2_value);
            else if(!var_declare_1_value.equals(""))
                broken_string.append(var_declare_1_value);
            else if(!func_value.equals(""))
                broken_string.append(func_value);
            else if(!struct_value.equals(""))
                broken_string.append(struct_value);
            else {
